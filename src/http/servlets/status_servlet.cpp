...
int32_t StatusServlet::handle(HttpRequest::ptr request, HttpResponse::ptr response,
  ...
  //   std::stringstream ss;
  //   ss << "===================================================" << std::endl;
  //   XX("server_version") << "server/1.0.0" << std::endl;
  ...
  //   std::endl; XX("main_start") << Time2Str(ProcessInfoMgr::GetInstance()->main_start_time) <<
  //   std::endl; XX("restart_count") << ProcessInfoMgr::GetInstance()->restart_count << std::endl;
  ...
  //         ss << "---------------------------------------------------" << std::endl;
  //       }
  //       if (!hs) { hs = std::dynamic_pointer_cast<sylar::http::HttpServer>(*iit); }
